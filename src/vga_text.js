 ...
 * @param {VGAScreen} vga
 */
function GraphicalText(bus, vga)
{
    this.bus = bus;
    this.vga = vga;

    /**
     * If true then txt_width and/or txt_height were changed
     * @type{boolean}
     */
    this.txt_size_dirty = false;
...
GraphicalText.prototype.resize_canvas = function()
{
    ...
    this.bus.send("screen-set-size-graphical", [
        this.gfx_width, this.gfx_height,
        this.gfx_width, this.gfx_height,
        32  // TODO: bpp from where?
    ]);
    this.bus.send("screen-settings-changed", [
        false,
...
GraphicalText.prototype.redraw = function()
{
    this.txt_row_dirty.fill(1);
    this.txt_dirty = 1;
};
...
GraphicalText.prototype.render = function()
{
    ...
    // apply changes to txt_width or txt_height further down below
    let screen_size_changed = this.txt_size_dirty;
    this.txt_size_dirty = false;
